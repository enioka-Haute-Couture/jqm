...
const ClassLoadersPage: React.FC = () => {
    ...
    const allowedRunnersInputRef = useRef(null);
    ...
    const handleOnSave = useCallback(
        (tableMeta: MUIDataTableMeta) => {
            ...
            const { value: allowedRunners } = allowedRunnersInputRef.current!;
        ...
        [childFirst, hiddenClasses, persistent, tracingEnabled, updateClassLoader]
    );
    ...
    const columns = [
        ...
        },
        {
            ...
            options: {
                ...
                filter: true,
                sort: true,
                // TODO: actually list  separated by commas
                customBodyRender: renderInputCell(
                    allowedRunnersInputRef,
                    editingRowId
                ),
            },
        },
    ...
    return classLoaders ? (
        <Container maxWidth={false}>
            <HelpDialog
                ...
                title="Class loaders documentation"
                // TODO:
                header=""
            ...
            {editHiddenClassesClId !== null && (
                <EditHiddenClassesDialog
                    ...
                    hiddenClasses={hiddenClasses.split(',') || []}
