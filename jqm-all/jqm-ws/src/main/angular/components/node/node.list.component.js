...
class NodeListCtrl
{
    constructor(µNodeDto, jqmCellTemplateBoolean, jqmCellEditorTemplateBoolean, uiGridConstants)
    {
        var ctx = this;
...
NodeListCtrl.$inject = ['µNodeDto', 'jqmCellTemplateBoolean', 'jqmCellEditorTemplateBoolean', 'uiGridConstants'];
