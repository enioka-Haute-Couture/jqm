...
@Provider
public class JqmAdminApiUserExceptionMapper implements ExceptionMapper<JqmAdminApiUserException>
{
    @Context
    private HttpHeaders headers;

    @Override
    public Response toResponse(JqmAdminApiUserException exception)
    {
