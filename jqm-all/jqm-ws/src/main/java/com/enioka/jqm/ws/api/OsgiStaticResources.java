 ...
 */
@Component(service = OsgiStaticResources.class, property = { org.osgi.framework.Constants.SERVICE_RANKING + ":Integer=" + Integer.MIN_VALUE,
        "osgi.http.whiteboard.context.select=(osgi.http.whiteboard.context.name=MAIN_HTTP_CTX)" })
@HttpWhiteboardResource(pattern = "/static/*", prefix = "/dist/static")
public class OsgiStaticResources
{
