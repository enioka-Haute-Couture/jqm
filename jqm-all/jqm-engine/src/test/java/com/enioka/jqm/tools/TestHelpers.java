...
public class TestHelpers
{
	...
	public static void createLocalNode(EntityManager em)
	{
		...
		TestHelpers.node = CreationTools.createNode("localhost", 8081, "./testprojects/jqm-test-deliverable/", "./testprojects/", "./testprojects/jqm-test-xml/", em);
		TestHelpers.node2 = CreationTools.createNode("localhost2", 8082, "./testprojects/jqm-test-deliverable/", "./testprojects/", "./testprojects/jqm-test-xml/", em);
		TestHelpers.node3 = CreationTools.createNode("localhost3", 8083, "./testprojects/jqm-test-deliverable/", "./testprojects/", "./testprojects/jqm-test-xml/", em);
		TestHelpers.nodeMix = CreationTools.createNode("localhost4", 8084, "./testprojects/jqm-test-deliverable/", "./testprojects/", "./testprojects/jqm-test-xml/", em);
		TestHelpers.nodeMix2 = CreationTools.createNode("localhost5", 8085, "./testprojects/jqm-test-deliverable/", "./testprojects/", "./testprojects/jqm-test-xml/", em);
