...
public class EngineApiGetStatus implements Runnable
{
    ...
    public void run()
    {
        ...
        prms.put("fail", "1");
        long failId = jm.enqueueSync(jm.applicationName(), jm.userName(), null, null, null, null, null, null, null, null, prms);

        prms = new HashMap<>();
        prms.put("succeed", "1");
        long successId = jm.enqueueSync(jm.applicationName(), jm.userName(), null, null, null, null, null, null, null, null, prms);
