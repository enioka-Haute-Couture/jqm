...
public class JmxRemoteSslWithoutAuthWithoutCredentialsTest extends JqmBaseTest
{
    ...
    {
        JmxTest.jmxRemoteSslTest(this, true, false, true, false, true, false, false, false);
    }
