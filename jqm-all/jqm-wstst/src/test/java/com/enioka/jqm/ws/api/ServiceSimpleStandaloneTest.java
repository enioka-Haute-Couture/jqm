...
public class ServiceSimpleStandaloneTest {

    @Test
    public void testFullIpToSequence() {
        final var ip = "192.168.124.234";
        final var expected = 192_168_124_234_000_000L;
        assertEquals(expected, ServiceSimpleStandalone.idSequenceBaseFromIp(ip));
    }
    ...
    public void testIdToFullIp() {
        ...
        assertEquals(expected, ServiceSimpleStandalone.ipFromId(id));
    }
