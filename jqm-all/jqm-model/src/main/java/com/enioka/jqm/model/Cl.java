...
public class Cl implements Serializable
{
    ...
    {
        return create(cnx, name, childFirst, hiddenClasses, tracing, persistent, allowedRunners, null);
    }

    public static Long create(DbConn cnx, String name, boolean childFirst, String hiddenClasses, boolean tracing, boolean persistent,
            String allowedRunners, String extraClasspathDirs)
    {
    ...
    public void update(DbConn cnx)
    {
        if (id == 0)
        {
            this.id = Cl.create(cnx, name, childFirst, hiddenClasses, tracingEnabled, persistent, allowedRunners, extraClasspathDirs);
        }
        else
        {
            cnx.runUpdate("cl_update_all_fields_by_id", name, childFirst, hiddenClasses, tracingEnabled, persistent, allowedRunners,
                    extraClasspathDirs, id);
        }
    }
}
