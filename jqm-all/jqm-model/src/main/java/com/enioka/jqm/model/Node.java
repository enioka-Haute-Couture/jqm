...
public class Node implements Serializable
{
    ...
    /**
     * If true, this node is a template node used to create new nodes, not an actual running node.
     *
     * @return true if this is a template node
     */
     ...
     *
     * @param template
     *            whether this is a template node
     */
    ...
    static Node map(DbConn cnx, ResultSet rs, int colShift)
    {
        try
        {
            ...
            tmp.template = rs.getBoolean(16 + colShift);
            tmp.lastSeenAlive = cnx.getCal(rs, 17 + colShift);
