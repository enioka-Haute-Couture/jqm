        ...
        try (Connection tmp = _ds.getConnection())
        {
            ...
            if ((dbAdaptersProp == null || dbAdaptersProp.isEmpty()) && FrameworkUtil.getBundle(getClass()) != null)
            {
                ...
                try
                {
                    ...
                    var serviceReferences = context.getServiceReferences(DbAdapter.class, "(Adapter-Type=*)");
                    ...
                    for (var ref : serviceReferences)
                    {
                        ...
                        var newAdapter = context.getService(ref);
                        if (newAdapter == null)
                        {
                            continue;
                        }
                        ...
                        if (newAdapter != null && newAdapter.compatibleWith(meta))
                        {
                            adapter = newAdapter;
                            break;
                        }
            ...
            else if (dbAdaptersProp != null && !dbAdaptersProp.isEmpty())
            {
            ...
            {
                throw new DatabaseException("No search method for db adapters available");
            }
        }
