...
class DbImplBase
{
    ...
    static
    {
        ...
        // NODE
        queries.put("node_insert",
                "INSERT INTO __T__NODE(ID, REPO_DELIVERABLE, DNS, ENABLED, JMX_REGISTRY_PORT, JMX_SERVER_PORT, "
        ...
        queries.put("jd_insert",
                "INSERT INTO __T__JOB_DEFINITION(ID, APPLICATION, JD_KEY, CL, " + "DESCRIPTION, ENABLED, EXTERNAL, HIGHLANDER, "
                        + "PATH, CLASS_NAME, JAVA_OPTS, KEYWORD1, KEYWORD2, KEYWORD3, ALERT_AFTER_SECONDS, " + "MODULE, PATH_TYPE, QUEUE) "
                        + "VALUES(JQM_PK.nextval, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        queries.put("jd_update_all_fields_by_id",
                "UPDATE __T__JOB_DEFINITION SET APPLICATION=?, JD_KEY=?, " + "DESCRIPTION=?, ENABLED=?, EXTERNAL=?, HIGHLANDER=?, "
        ...
        queries.put("jd_select_by_id_lock", queries.get("jd_select_all") + " WHERE ID=?"); // same as above. To allow some db
                                                                                           // (oracle...) to
                                                                                           // change this.
        ...
        // HISTORY
        queries.put("history_insert_with_end_date",
        ...
        // INPUT FILES
        queries.put("inputfile_insert",
                "INSERT INTO __T__INPUT_FILE(ID, FILE_FAMILY, PATH, JOB_INSTANCE, ORIGINAL_FILE_NAME, STORAGE_NODE) VALUES(JQM_PK.nextval, ?, ?, ?, ?, ?)");
        queries.put("inputfile_select_all",
                "SELECT ID, FILE_FAMILY, PATH, JOB_INSTANCE, ORIGINAL_FILE_NAME, STORAGE_NODE FROM __T__INPUT_FILE");
