...
(
	...
	NODE_ID INTEGER,
	QUEUE_ID INTEGER,
	CONSTRAINT FK_HISTORY_1 FOREIGN KEY(JOBDEF_ID) REFERENCES JOBDEF(ID) ON DELETE SET NULL,
	CONSTRAINT FK_HISTORY_2 FOREIGN KEY(NODE_ID) REFERENCES NODE(ID) ON DELETE SET NULL,
	CONSTRAINT FK_HISTORY_3 FOREIGN KEY(QUEUE_ID) REFERENCES QUEUE(ID) ON DELETE SET NULL
);
...
(
	...
	RESOURCE_ID INTEGER,
	CONSTRAINT FK_JNDIOBJECTRESOURCEPARAMETER_1 FOREIGN KEY(RESOURCE_ID) REFERENCES JNDIOBJECTRESOURCE(ID) ON DELETE CASCADE
);
...
(
	...
	CONSTRAINT FK_RPERMISSION_1 FOREIGN KEY(ROLE_ID) REFERENCES RROLE(ID) ON DELETE CASCADE
);
...
(
	...
	CONSTRAINT FK_RROLE_RUSER_1 FOREIGN KEY(ROLE_ID) REFERENCES RROLE(ID) ON DELETE CASCADE,
	CONSTRAINT FK_RROLE_RUSER_2 FOREIGN KEY(USER_ID) REFERENCES RUSER(ID) ON DELETE CASCADE
);
