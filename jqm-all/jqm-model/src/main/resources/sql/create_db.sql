...
(
	...
	CL_CHILD_FIRST BOOLEAN NOT NULL,
	CL_TRACING BOOLEAN NOT NULL,
	CL_HIDDEN_CLASSES VARCHAR(1024),
	CL_KEY VARCHAR(20),
...
CREATE INDEX IDX_FK_JOB_DEFINITION_PARAMETER_1 ON JOB_DEFINITION_PARAMETER(JOBDEF);
...
(
	...
	INTERNAL_POSITION DOUBLE NOT NULL,
...
(
	...
	CONSTRAINT UK_JNDI_OR_PARAMETER_1 UNIQUE(KEYNAME, RESOURCE),
	CONSTRAINT FK_JNDI_OR_PARAMETER_1 FOREIGN KEY(RESOURCE) REFERENCES JNDI_OBJECT_RESOURCE(ID) ON DELETE CASCADE
);
CREATE INDEX IDX_FK_JNDI_OR_PARAMETER_1 ON JNDI_OR_PARAMETER(RESOURCE);
...
(
	ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL, /* not actually needed, but simplifies things Java-side */
	ROLE INTEGER NOT NULL,
