 ...
 */
@Component(service = JqmClientFactory.class, scope = ServiceScope.SINGLETON, immediate = true)
public class JqmClientFactory
{
    private static BaseJqmClientFactory<JerseyClient> baseFactory = new BaseJqmClientFactory<JerseyClient>((Properties p) -> {
        return new JerseyClient(p);
    });

    //////////////////////////////////////////////////
    // Only run in OSGi context
    @Reference
    ...
    {
        baseFactory.setProperty("com.enioka.jqm.ws.jaxrsfactory", builder);
    }

    @Deactivate
    public void deactivate()
    {
        baseFactory.removeProperty("com.enioka.jqm.ws.jaxrsfactory");
        baseFactory.resetClient();
    }
    // End OSGi
    //////////////////////////////////////////////////
