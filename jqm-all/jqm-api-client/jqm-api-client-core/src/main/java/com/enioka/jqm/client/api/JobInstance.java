...
public class JobInstance
{
     ...
     * @param progress the progress of the job instance.
     */
     ...
     * @param keyword1 the definitionKeyword1
     */
     ...
     * @param keyword2 the definitionKeyword2
     */
     ...
     * @param keyword3 the definitionKeyword3
     */
     ...
     * @param enqueueDate the enqueue date
     */
     ...
     * @param beganRunningDate the beginning running date
     */
     ...
     * @param h true if highlander, false otherwise.
     */
     ...
     * @param b true if from schedule, false otherwise.
     */
