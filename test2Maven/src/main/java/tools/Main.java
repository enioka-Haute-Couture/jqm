...
//		}
		...
		try
		{
			...
			Dependencies plugMeIn = new Dependencies("/Users/pico/Dropbox/projets/enioka/JobQueueAPI/pom.xml");
			plugMeIn.print();
			...
			File file = new File("/Users/pico/Dropbox/projets/enioka/JobQueueAPI/target/testJobQueueAPI-0.0.1-SNAPSHOT.jar");
			URL[] url = {file.toURI().toURL()};
			ClassLoader cl = Thread.currentThread().getContextClassLoader();

			URL[] tmp = ((URLClassLoader)cl).getURLs();
			...
			//System.getProperty("Original"+ "java.class.path");
